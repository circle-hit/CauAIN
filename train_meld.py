...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    for data in dataloader:
        ...
        x1, x2, x3, x4, x5, x6, \
        o1, o2, o3, \
        qmask, umask, label, inter_c_e_mask, intra_c_e_mask, inter_position_index, intra_position_index = [d.cuda() for d in data] if cuda else data
        ...
        log_prob = model(r1, r2, r3, r4, x1, x2, x3, x4, x5, x6, o1, o2, o3, qmask, umask, inter_c_e_mask, intra_c_e_mask, speaker_ids)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=7600, metavar='seed', help='seed')
    ...
    for e in range(n_epochs):
        ...
        if test_fscore[0] > max_test_f1:
            ...
            increase_flag = True
            if args.save:
                torch.save(model.state_dict(), open('./meld/cauain_best_model.pkl', 'wb'))
