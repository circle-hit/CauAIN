...
from model import MaskedNLLLoss, CauAIN
...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    for data in dataloader:
        ...
        log_prob = model(r1, r2, r3, r4, x1, x2, x3, x4, x5, x6, o1, o2, o3, qmask, umask, inter_c_e_mask, intra_c_e_mask, speaker_ids, att2=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=8100, metavar='seed', help='seed')
    ...
    seed_everything(seed)
    model = CauAIN(args)
    print ('DailyDialog CauAIN Model.')
    if cuda:
        model.cuda()
    ...
    for e in range(n_epochs):
        ...
        if test_fscore[0] > max_test_f1:
            ...
            increase_flag = True
            if args.save:
                torch.save(model.state_dict(), open('./dailydialog/best_model.pkl', 'wb'))
    ...
    score4 = test_fscores[1][np.argmin(valid_losses)]
    score5 = test_fscores[1][np.argmax(valid_fscores[1])]
    score6 = test_fscores[1][np.argmax(test_fscores[1])]
    scores = [score1, score2, score3, score4]
    scores_val_loss = [score1, score4]
    scores_val_f1 = [score2, score5]
    scores_test_f1 = [score3, score6]
    ...
    print('F1@Best Valid F1: {}'.format(scores_test_f1))
